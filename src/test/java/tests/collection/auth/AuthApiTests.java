...
public class AuthApiTests extends BaseSectionTest {
    ...
    @Test
    @Order(1)
    @DisplayName("Получение токена - 200")
    ...
    @Test
    @Order(2)
    @DisplayName("Получение справочника страховых программ - 401 expired token")
    ...
    @Test
    @Order(3)
    @DisplayName("Получение токена - 400 неверный client_id")
    ...
    @Test
    @Order(5)
    @DisplayName("Получение страховой программы - 403 without token")
    ...
    @Test
    @Order(6)
    @DisplayName("Получение страховой программы - 401 invalid token")
